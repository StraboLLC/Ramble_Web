...
function plotTrack(idx) {
	...
	tracks[idx].richMarker = new RichMarker({
		...
		content: '<div class="marker"><div id="'+idx+'-marker" class="video-camera-marker" style="transform:rotate('+deg+'deg);-moz-transform:rotate('+deg+'deg);-webkit-transform:rotate('+deg+'deg);-o-transform:rotate('+deg+'deg);-ms-transform:rotate('+deg+'deg);" ><img src="/app/assets/images/videocamera.png" alt="" /></div><div class="tooltip"><img src="//graph.facebook.com/'+tracks[idx].user_id+'/picture" alt="" title="'+tracks[idx].name+'"/></div></div>'
	});
...
function rotationArrow(deg) {
	...
	//image.src="/app/assets/images/videocamera.png";
